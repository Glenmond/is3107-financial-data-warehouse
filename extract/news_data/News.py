...
class News():
    def __init__(self, base_dir='../data/sentiment_data/extract/'):
        ...
        self.news_sources_df = None
        self.news_volume_spikes_df = None
        self.start = None
        self.end = None
    ...
    def get_contents(self, from_year):
        ...
        self.news_sources_df = news_sources_df
        self.news_volume_spikes_df = news_volume_spikes_df

        return news_sources_df, news_volume_spikes_df
